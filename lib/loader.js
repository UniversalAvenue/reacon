...
var Loader = function () {
  function Loader() {
    ...
    var _ref$mapContext = _ref.mapContext;
    var mapContext = _ref$mapContext === undefined ? {} : _ref$mapContext;
    var _ref$mapArgs = _ref.mapArgs;
    var mapArgs = _ref$mapArgs === undefined ? [] : _ref$mapArgs;
  ...
  _createClass(Loader, [{
    ...
    value: function assemble(script, graph) {
      ...
      return this.PromiseRef.all(graph.topologicalSort().map(function (dep) {
        ...
        return '(function (factory, components) {\n        var locals = {\n          ' + dependencies + '\n        };\n        function Component(props) {\n          return ' + script + ';\n        }\n        Component.displayName = ' + JSON.stringify(name) + ';\n        return Component;\n      })';
      });
    }
  }, {
    key: 'compile',
